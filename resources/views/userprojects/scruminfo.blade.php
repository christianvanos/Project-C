...
<div class="info">
    ...
    <h2>Artefacts</h2>
        <div class="Artefacts">
            ...
            <p>The Product Owner is in charge of the Product Backlog and manages it along with the priotities.</p>
            <br>
            <h4>-Sprint Backlog</h4>
            <p>The Sprint Backlog provides an overview for all the selected items from the Product Backlog that the Development Team will work on during the upcomming sprint.</p>
            <br>
            ...
            <br>
            <h4>-Scrumboard</h4>
            <p>A Scrumboard shows the items that are in the product backlog along with their current state of progression and who from the developer team is working on them.</p>
            <br>
            <h4>-User Story</h4>
